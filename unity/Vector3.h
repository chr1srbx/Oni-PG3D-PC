...
struct Vector3
{
     ...
     * @return: A new vector.
     */
    static inline Vector3 MoveTowards(Vector3 current, Vector3 tobjet,
     ...
     * @return: A new vector.
     */
    static inline Vector3 RotateTowards(Vector3 current, Vector3 tobjet,
...
Vector3 Vector3::MoveTowards(Vector3 current, Vector3 tobjet,
                             float maxDistanceDelta)
{
    Vector3 d = tobjet - current;
    float m = Magnitude(d);
...
Vector3 Vector3::RotateTowards(Vector3 current, Vector3 tobjet,
                               float maxRadiansDelta,
                               float maxMagnitudeDelta)
{
    ...
    Vector3 axis = Cross(current, tobjet);
